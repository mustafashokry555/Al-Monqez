...
use App\Http\Requests\Admin\StoreApp\Categories\AddCategoryRequest;
use App\Http\Requests\Admin\StoreApp\Categories\UpdateCategoryRequest;
use App\Http\Requests\Admin\StoreApp\Categories\ValidateCategoryRequest;
...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.store-app.categories.index', compact('categories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.store-app.categories.create', compact('languages'));
    }
    ...
    public function store(AddCategoryRequest $request)
    {
        ...
        $data = array_merge($data, [
            'image' => $this->uploadFile($request, 'store-categories'),
    ...
    public function edit($id)
    {
        ...
        return view('admin.store-app.categories.edit', compact('category', 'languages'));
    }
    ...
    public function update(UpdateCategoryRequest $request)
    {
        ...
        $data = array_merge($data, [
            'image' => $this->uploadFile($request, 'store-categories', $category)
        ]);
