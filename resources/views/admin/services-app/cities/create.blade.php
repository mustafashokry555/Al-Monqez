...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
            <a class="btn bg-primary text-white btn-sm ml-2" title="{{ __('admin.back') }}" href="{{ route('services_app.admin.cities.index') }}">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.add_city') }}</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('services_app.admin.cities.store') }}" method="POST">
                        @csrf
                        ...
                        @endforeach
                        <button class="btn btn-primary" type="submit">{{ __('admin.add_city') }}</button>
                    </form>
                </div>
            </div>
            <!-- end card -->
