    ...
    @component('components.breadcrumb')
        @slot('li_1')
            <a class="btn bg-primary text-white btn-sm ml-2" title="{{ __('admin.back') }}"
                href="{{ route('services_app.admin.services.index') }}">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.add_service') }}</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('services_app.admin.services.store') }}" method="POST"
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="input"
                                            ...
                                            placeholder="{{ __('admin.brief') }}" value="{{ old("brief_$language") }}"
                                            required>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="input"
                                            ...
                                            value="{{ old("description_$language") }}" required>
                        ...
                        @endforeach
                        <button class="btn btn-primary" type="submit">{{ __('admin.add_service') }}</button>
                    </form>
                </div>
            </div>
            <!-- end card -->
