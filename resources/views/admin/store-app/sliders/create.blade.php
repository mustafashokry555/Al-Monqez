...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
            <a class="btn bg-primary text-white btn-sm ml-2" title="{{ __('admin.back') }}" href="{{ route('store_app.admin.sliders.index') }}">
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.add_slider') }}</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('store_app.admin.sliders.store') }}" method="POST"
                        ...
                        <button class="btn btn-primary" type="submit">{{ __('admin.add_slider') }}</button>
                    </form>
                </div>
            </div>
            <!-- end card -->
