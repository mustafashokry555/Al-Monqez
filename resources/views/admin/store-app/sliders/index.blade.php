            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (isset($super_admin) || isset($slider_create))
                        <a href="{{ route('store_app.admin.sliders.create') }}" class="btn btn-primary button-icon"><i
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex">
                                            @if (isset($super_admin) || isset($slider_edit))
                                                <form class="d-inline ml-2" action="{{ route('store_app.admin.sliders.display') }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                ...
                                                <a class="btn btn-outline-secondary bg-warning text-dark btn-sm ml-2"
                                                    title="{{ __('admin.edit') }}"
                                                    href="{{ route('store_app.admin.sliders.edit', [$slider->id]) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content modal-content-demo">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form class="d-inline"
                                                                action="{{ route('store_app.admin.sliders.destroy') }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('Delete')
