            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @if (isset($super_admin) || isset($category_create))
                        <a href="{{ route('store_app.admin.categories.create') }}" class="btn btn-primary button-icon"><i
                                        ...
                                        <div class="d-flex">
                                            @if (isset($super_admin) || isset($category_edit))
                                                <form class="d-inline ml-2"
                                                    action="{{ route('store_app.admin.categories.display') }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                ...
                                                <a class="btn btn-outline-secondary bg-warning text-dark btn-sm ml-2"
                                                    title="{{ __('admin.edit') }}"
                                                    href="{{ route('store_app.admin.categories.edit', [$category->id]) }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content modal-content-demo">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form class="d-inline"
                                                                action="{{ route('store_app.admin.categories.destroy') }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('Delete')
