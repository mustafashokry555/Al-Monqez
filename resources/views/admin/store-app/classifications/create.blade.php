        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.add_classification') }}</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('store_app.admin.classifications.store') }}"
                        method="POST">
                        @csrf
                        ...
                        @endforeach
                        <button class="btn btn-primary" type="submit">{{ __('admin.add_classification') }}</button>
                    </form>
                </div>
            </div>
            <!-- end card -->
