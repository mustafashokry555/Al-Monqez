    ...
    @component('components.breadcrumb')
        @slot('li_1')
            <a class="btn bg-primary text-white btn-sm ml-2" title="{{ __('admin.back') }}"
                href="{{ route('store_app.admin.coupons.index') }}">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.edit_coupon') }}</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('store_app.admin.coupons.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="input" class="form-control @error('coupon_code') is-invalid @enderror"
                                        ...
                                        value="{{ old('coupon_code') ? old('coupon_code') : $coupon->code }}" required>
                                    @error('coupon_code')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        value="{{ old('discount_percentage') ? old('discount_percentage') : $coupon->discount_percentage }}"
                                        required>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('max_discount_amount') ? old('max_discount_amount') : $coupon->max_discount_amount }}"
                                        required>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('valid_from') is-invalid @enderror"
                                        ...
                                        value="{{ old('valid_from') ? old('valid_from') : $coupon->valid_from }}" required>
                                    @error('valid_from')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('valid_until') is-invalid @enderror"
                                        ...
                                        value="{{ old('valid_until') ? old('valid_until') : $coupon->valid_until }}"
                                        required>
                                    @error('valid_until')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                        ...
                        <button class="btn btn-primary" type="submit">{{ __('admin.edit_coupon') }}</button>
                    </form>
                </div>
            </div>
            <!-- end card -->
