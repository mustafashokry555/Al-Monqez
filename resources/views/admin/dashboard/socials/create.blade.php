        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.add_social') }}</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('admin.socials.store') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <label class="form-label" for="icon">{{ __('admin.icon') }} <span
                        ...
                        <button class="btn btn-primary" type="submit">{{ __('admin.add_social') }}</button>
                    </form>
                </div>
            </div>
            <!-- end card -->
