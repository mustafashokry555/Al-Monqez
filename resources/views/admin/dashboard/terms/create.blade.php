        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.add_term') }}</h4>
                </div>
                <div class="card-body">
                    <form class="needs-validation" action="{{ route('admin.terms.store') }}" method="POST">
                        @csrf
                        ...
                        @endforeach
                        <button class="btn btn-primary" type="submit">{{ __('admin.add_term') }}</button>
                    </form>
                </div>
            </div>
            <!-- end card -->
