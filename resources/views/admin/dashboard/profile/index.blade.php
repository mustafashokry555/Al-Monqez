...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
            {{ __('admin.control') }} {{ __('admin.profile') }} !
        @endslot
    @endcomponent
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title m-0">{{ __('admin.update_profile') }}</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <a href="{{ auth()->user()->imageLink }}" target="_blanck">
                                            <img src="{{ auth()->user()->imageLink }}" alt="{{ __('admin.image') }}"
                            ...
                            @if ($storeDetail)
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="city_id" class="form-control @error('city_id') is-invalid @enderror"
                                            ...
                                            @foreach ($cities as $city)
                                                <option value="{{ $city->id }}" @selected($storeDetail->city_id == $city->id)>
                                                    {{ $city->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('city_id')
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <select name="category_id"
                                            ...
                                            id="category_id" onchange="getSubCategories(this)" required>
                                            <option value="" selected disabled>{{ __('admin.choose_category') }}
                                            </option>
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" @selected($storeDetail->category_id == $category->id)>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="input"
                                                ...
                                                value="{{ $storeDetail->{"address_$language"} }}" required>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <div>
                                            <a href="{{ $storeDetail->coverImageLink }}" target="_blanck">
                                                <img src="{{ $storeDetail->coverImageLink }}"
                                                    alt="{{ __('admin.cover_image') }}"
                                                    class="img-thumbnail wd-100p wd-sm-200" />
                                            </a>
                                        </div>
                                        <input type="file"
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="commercial_registration">صورة السجل التجاري <span
                                                class="text-danger fw-bolder">*</span></label>
                                        <div>
                                            <a href="{{ $storeDetail->commercialRegistrationLink }}" target="_blanck">
                                                <img src="{{ $storeDetail->commercialRegistrationLink }}"
                                                    alt="صورة السجل التجاري" class="img-thumbnail wd-100p wd-sm-200" />
                                            </a>
                                        </div>
                                        <input type="file"
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="license">صورة الرخصة <span
                                                class="text-danger fw-bolder">*</span></label>
                                        <div>
                                            <a href="{{ $storeDetail->licenseLink }}" target="_blanck">
                                                <img src="{{ $storeDetail->licenseLink }}" alt="صورة الرخصة"
                                                    class="img-thumbnail wd-100p wd-sm-200" />
                                            </a>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $storeDetail->bank_name }}" required>
                                        @error('bank_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="اسم صاحب الحساب" value="{{ $storeDetail->account_holder_name }}"
                                            required>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('IBAN') is-invalid @enderror"
                                            id="IBAN" name="IBAN" placeholder="الايبان"
                                            value="{{ $storeDetail->IBAN }}" required>
                                        @error('IBAN')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
